...
<img class="wp-simple-seo-tags-social-media-image-preview <?php echo (isset($post_seo_atts[0]['post-social-media-image-url'])) ? 'preview-visible' : ''; ?>" <?php echo (isset($post_seo_atts[0]['post-social-media-image-url'])) ? 'src='.$post_seo_atts[0]['post-social-media-image-url'] : ''; ?>>
